...
function blog_list_enqueue_block_editor_assets() {
    wp_enqueue_script(
        ...
        BLOG_LIST_PLUGIN_URL . 'build/block.js',
...
function blog_list_init() {
    ...
    require_once BLOG_LIST_PLUGIN_DIR . 'includes/classbloglistblock.php';
    ...
    if ( function_exists( 'register_block_type' ) ) {
        ...
        register_block_type(
            'blog-list/block',
            array(
                'editor_script'   => 'blog-list-block-script',
                'render_callback' => 'blog_list_block_render',
                'attributes'      => array(
                    'postsPerPage' => array(
                        'type'    => 'number',
                        'default' => 10,
